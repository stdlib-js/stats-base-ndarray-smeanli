...
var smeanli = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
...
tape( 'main export is a function', opts, function test( t ) {
	...
	t.strictEqual( typeof smeanli, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function has an arity of 1', opts, function test( t ) {
	t.strictEqual( smeanli.length, 1, 'has expected arity' );
	t.end();
});
